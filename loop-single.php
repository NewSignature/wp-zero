...
<article <?php post_class(); ?> itemscope="" itemtype="http://schema.org/Article">
  ...
  <header>
    ...
    <time itemprop="datePublished" pubdate datetime="<?php echo get_the_date('c'); ?>"><?php echo get_the_date(); ?> - <?php the_time(); ?></time>

    <?php // 4) Display and link to the author ?>
    <span itemprop="author" itemscope itemtype="http://schema.org/Person">
        <a itemprop="url" href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) ); ?>"><span itemprop="name"><?php the_author(); ?></span></a>
      </span>
